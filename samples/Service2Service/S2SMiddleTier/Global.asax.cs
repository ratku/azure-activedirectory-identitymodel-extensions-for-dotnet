...
namespace S2SMiddleTier
{
    ...
    {
        // constants related to this site: S2SMiddleTier
        public const string Address    = "http://localhost:39273/";
        public const string Authority  = "https://testingsts.azurewebsites.net/";
        public const string Audience1  = "http://S2SMiddleTier";
        public const string Audience2  = "http://S2SMiddleTier/";
        ...
        public const string SiteName   = "S2SMiddleTier";
        ...
        public static X509Certificate2 FindCertificate(StoreLocation storeLocation, StoreName storeName, string thumbprint)
        {
            ...
            try
            {
                ...
                throw new ArgumentException(
                    string.Format("S2SMiddleTier communicates with AzureAD using a Certificate with thumbprint: '{0}'. SAL_SDK includes '<ROOT>\\src\\Certs\\S2SMiddleTier.pfx' that needs to be imported into 'LocalComputer\\Personal' (password is: S2SMiddleTier).{1}'<ROOT>\\src\\ToolsAndScripts\\AddPfxToCertStore.ps1' can be used install certs.{1}Make sure to open the powershell window as an administrator.", 
                        thumbprint,
                        Environment.NewLine));
            }
            finally
